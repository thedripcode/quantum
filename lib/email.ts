  ...
  await getResend().emails.send({
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto;background:#0C0C0C;color:#fff;border-radius:16px;overflow:hidden;">
        <div style="background:#60a5fa;padding:24px 32px;">
        ...
        <div style="padding:32px;">
          ...
          <a href="${resetUrl}" style="display:inline-block;background:#60a5fa;color:#000;text-decoration:none;padding:13px 28px;border-radius:10px;font-weight:700;font-size:15px;">Reset My Password</a>
      ...
      <div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto;background:#0C0C0C;color:#fff;border-radius:16px;overflow:hidden;">
        ...
        <div style="padding:32px;">
          ...
          <div style="background:#161616;border:1px solid rgba(255,255,255,0.08);border-radius:12px;padding:18px 20px;margin-bottom:24px;">
            ...
            <p style="margin:0;font-size:24px;font-weight:800;color:#60a5fa;letter-spacing:0.05em;">${ref}</p>
          </div>
        ...
        <div style="padding:32px;">
          ...
          <div style="background:#161616;border:1px solid rgba(255,255,255,0.08);border-radius:12px;padding:18px 20px;margin-bottom:24px;">
            <div style="margin-bottom:12px;">
              ...
              <p style="margin:0;font-size:18px;font-weight:700;color:#60a5fa;">${portalId}</p>
            </div>
            <div style="margin-bottom:12px;">
          ...
          <a href="${loginUrl}" style="display:inline-block;background:#60a5fa;color:#000;text-decoration:none;padding:13px 28px;border-radius:10px;font-weight:700;font-size:15px;">Login to Student Portal</a>
          <hr style="border:none;border-top:1px solid rgba(255,255,255,0.08);margin:24px 0;">
          <p style="margin:0;font-size:11px;color:rgba(255,255,255,0.25);">Sidelile High School · sidelile.edu.za</p>
        </div>
      </div>
